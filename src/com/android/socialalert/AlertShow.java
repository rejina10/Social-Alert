...
public class AlertShow extends AlertDialog.Builder {
    ...
    public AlertShow(Context context) {
        ...
        mDivider.setBackgroundColor(Color.parseColor("#E82D22"));
     ...
     *            for passing "#ffffff"
     */
    public AlertShow setDividerColor(String colorString) {
        mDivider.setBackgroundColor(Color.parseColor(colorString));
        return this;
    }

    @Override
    public AlertShow setTitle(CharSequence text) {
        mTitle.setText(text);
        return this;
    }

    public AlertShow setTitleColor(String colorString) {
        mTitle.setTextColor(Color.parseColor(colorString));
        return this;
    }

    @Override
    public AlertShow setMessage(int textResId) {
        mMessage.setText(textResId);
        return this;
    }

    @Override
    public AlertShow setMessage(CharSequence text) {
        mMessage.setText(text);
        return this;
    }

    @Override
    public AlertShow setIcon(int drawableResId) {
        mIcon.setImageResource(drawableResId);
        return this;
    }

    @Override
    public AlertShow setIcon(Drawable icon) {
     ...
     * @param context
     */
    public AlertShow setCustomView(int resId, Context context) {
